...
import Language.SOQL.Lexer as SOQL
...
soqlLiteral :: P String
soqlLiteral = PC.between (PS.char '[') (PS.char ']') (PC.lookAhead $ istring "select")
    -- _ <- PC.lookAhead $ istring "select"
    
    -- pure $ SOQL.lexSOQL soqlString
    -- where
    --     readString = fromCharArray <$> (Array.many PS.anyChar) 
