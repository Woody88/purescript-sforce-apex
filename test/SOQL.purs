  ...
  describe "SOQL Parser case test parses" do
    ...
    it "SetExpr" do
        let x        = "BillingState IN ('California', 'New York')"
            expected = Right (SetExpr (Field $ fieldT "BillingState") IN (String "California" : String "New York" : Nil))
    ...
    describe "SimpleExpr" do 
        it "SExpr" do 
            let x        = "BillingState IN ('California', 'New York')"
                expected = Right (SExpr (SetExpr (Field $ fieldT "BillingState") IN (String "California" : String "New York" : Nil)))
